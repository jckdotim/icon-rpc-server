...
"""json rpc dispatcher version node"""
...
from iconrpcserver.utils import convert_method_to_lower_camel
...
class NodeDispatcher:
    ...
    async def dispatch(request, channel_name=None):
        ...
        method_name = convert_method_to_lower_camel(req_json["method"])
        req_json["method"] = method_name
        req_json["params"] = req_json.get("params", {})

        if 'message' in req_json['params']:
